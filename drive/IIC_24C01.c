...
void i2c_CfgGpio(void)
{
	...
	RCC_AHBPeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE);//开启GPIOF时钟

	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_14;//定义端口PD
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_OD;//设置为输出模式
	GPIO_InitStruct.GPIO_Speed =GPIO_Speed_2MHz;//设置输出频率
	GPIO_Init(GPIOC, &GPIO_InitStruct);//将设置输入函数
	
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_15;//定义端口PB
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_OD;//设置为输出模式
	GPIO_InitStruct.GPIO_Speed =GPIO_Speed_2MHz;//设置输出频率
	GPIO_Init(GPIOC, &GPIO_InitStruct);//将设置输入函数
